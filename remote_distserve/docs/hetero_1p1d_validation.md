...
TTFT p50 基本没有明显改善，也没有明显破坏；TPOT 从 p50 到 p99 都更稳定，收益在 p90/p99 更明显。这个结果说明 PhaseServe 当前最强的证据不是让普通请求更快得到首 token，而是减少异构 decode 请求之间的尾延迟干扰。

| Rate | Policy | TTFT p50 | TTFT p90 | TTFT p99 | TPOT p50 | TPOT p90 | TPOT p99 |
|---:|---|---:|---:|---:|---:|---:|---:|
| 0 | Phase | 0.578 | 7.938 | 9.585 | 0.0406 | 0.130 | 0.153 |
| 0 | FCFS | 0.521 | 7.478 | 9.722 | 0.0437 | 0.154 | 0.193 |
| 1 | Phase | 0.0392 | 0.0536 | 0.078 | 0.0153 | 0.0171 | 0.0203 |
| 1 | FCFS | 0.0391 | 0.0537 | 0.075 | 0.0150 | 0.0186 | 0.0298 |
| 2 | Phase | 0.0390 | 0.0544 | 0.080 | 0.0176 | 0.0328 | 0.0434 |
| 2 | FCFS | 0.0379 | 0.0547 | 0.077 | 0.0190 | 0.0561 | 0.0795 |
| 4 | Phase | 0.0394 | 0.196 | 0.712 | 0.0266 | 0.0887 | 0.109 |
| 4 | FCFS | 0.0395 | 0.431 | 2.157 | 0.0334 | 0.138 | 0.177 |

按 paired ratio 看：

| Rate | TTFT p50 ratio | TTFT p90 ratio | TPOT p50 ratio | TPOT p90 ratio | TPOT p99 ratio |
|---:|---:|---:|---:|---:|---:|
| 0 | 1.097 | 1.114 | 0.941 | 0.845 | 0.817 |
| 1 | 1.004 | 0.999 | 1.022 | 0.946 | 0.816 |
| 2 | 1.030 | 0.994 | 0.944 | 0.647 | 0.579 |
| 4 | 1.003 | 0.688 | 0.823 | 0.640 | 0.614 |

因此论文中更稳妥的表述是：PhaseServe 主要改善 TPOT 的中高分位和尾部延迟，并在高 KV 压力下同步改善 TTFT p90/p99；median TTFT 不是主要收益点。

## 吞吐量

PhaseServe 在轻载/中载下基本保持与 FCFS 相同的吞吐；在 burst 和高 KV-pressure 下有小幅吞吐提升，并且 SLO goodput 提升更明显。

| Rate | Policy | Submitted req/s | Completed req/s | Goodput req/s | Input tok/s | Output tok/s | Total tok/s |
|---:|---|---:|---:|---:|---:|---:|---:|
| 0 | Phase | 1.521 | 1.521 | 1.503 | 376.9 | 384.5 | 761.4 |
| 0 | FCFS | 1.439 | 1.439 | 1.364 | 357.1 | 363.9 | 721.0 |
| 1 | Phase | 0.920 | 0.920 | 0.920 | 229.8 | 236.2 | 466.0 |
| 1 | FCFS | 0.923 | 0.923 | 0.923 | 230.5 | 237.0 | 467.5 |
| 2 | Phase | 1.350 | 1.350 | 1.350 | 336.4 | 342.9 | 679.3 |
| 2 | FCFS | 1.347 | 1.347 | 1.347 | 335.6 | 342.0 | 677.6 |
| 4 | Phase | 1.533 | 1.533 | 1.533 | 380.6 | 387.0 | 767.6 |
| 4 | FCFS | 1.468 | 1.468 | 1.468 | 364.7 | 371.0 | 735.7 |

Paired throughput ratio：

| Rate | Completed req/s ratio | Goodput ratio | Output tok/s ratio | Total tok/s ratio |
|---:|---:|---:|---:|---:|
| 0 | 1.058 | 1.107 | 1.058 | 1.058 |
| 1 | 0.997 | 0.997 | 0.997 | 0.997 |
| 2 | 1.002 | 1.002 | 1.002 | 1.002 |
| 4 | 1.043 | 1.043 | 1.043 | 1.043 |
